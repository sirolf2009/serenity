  ...
  public void createPartControl(final Composite parent) {
    ...
    final Consumer<OrderBook> _function = (OrderBook it) -> {
      ...
      final Function1<LimitOrder, Double> _function_2 = (LimitOrder it_1) -> {
        return Double.valueOf(it_1.getLimitPrice().doubleValue());
      };
      ...
      final Function1<LimitOrder, Double> _function_5 = (LimitOrder it_1) -> {
      ...
      final Double asks = IterableExtensions.<Double>reduce(IterableExtensions.<LimitOrder, Double>map(IterableExtensions.<LimitOrder>filter(it.getAsks(), _function_4), _function_5), _function_6);
